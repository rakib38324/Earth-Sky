        ...
        <div className="bg-gray-900 py-20 px-10 opacity-90 rounded-3xl">
          ...
          {loading === true ? (
                  ...
                  {dateWithData.near_earth_objects?.[`${buttonDate}`]?.map(
                    (element, index) => (
                      <div
                        ...
                        key={element?.id}
                        className="grid md:grid-cols-6 bg-blue-200 rounded-lg my-1 lg:w-2/3 mx-auto cursor-pointer hover:bg-green-300  "
                      >
            ...
            <div>
              {data?.near_earth_objects?.length &&
                data?.near_earth_objects?.map((element, index) => (
                  <div
                    onClick={() => handleSingleData(element?.links?.self)}
                    key={element?.id}
                    className="grid md:grid-cols-6 bg-blue-200 rounded-lg my-1 lg:w-2/3 mx-auto cursor-pointer hover:bg-green-300 hover:border-[1px] hover:border-green-600 "
                  >
                    <div className="flex gap-2 md:col-span-2">
                      <p className="pl-2 my-auto font-bold">{index + 1}.</p>
                      <p className="p-2  font-semibold ">
              ...
              <div
                onClick={() =>
                  handleDownload(data?.near_earth_objects, "Asteroids - NeoWs")
                }
                className="flex justify-center"
              >
                <button className="p-2 px-4 font-semibold hover:bg-green-400 bg-blue-300 text-lg my-10 rounded-lg">
